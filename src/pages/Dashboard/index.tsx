      ...
      <Container>
        <CardContainer>
          <Card>
            ...
            <h1 data-testid="balance-income">{balanceValue.income}</h1>
          </Card>
          <Card>
            <header>
              <p>Saídas</p>
            ...
            <h1 data-testid="balance-outcome">{balanceValue.outcome}</h1>
          </Card>
          <Card total>
            <header>
              <p>Total</p>
            ...
            <h1 data-testid="balance-total">{balanceValue.total}</h1>
          </Card>
        </CardContainer>
